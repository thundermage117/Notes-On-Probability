...
$$P(\lim_{n \to \infty} \bigcup_{i=1}^{n}E_i)=\lim_{i \to \infty }P(E_i)$$%incomplete
...
Probability spaces vary a lot based on the experiment. To be able to develop a theory of probability which is indepedent of the actual experiment which is performed.
...
$$ \bigcup_{i=1}^{\infty}(-\infty ,x_i] = \bigcup_{i=1}^{\infty} E_i =$$
%incomplete
...
A function is said to be%incomplete
...
$$ X^-1\left( (-\infty, x ]\right) \leftarrow $$
%incomplete
